...
const emailVerificationMailgenContent = (
  ...
  return {
    body: {
      name: username,
      intro:
        "You have successfully created an account on our platform. Please verify your email address by clicking on the button below.",
      action: {
        instructions:
      ...
      outro:
        "If you did not create an account, please ignore this email or reply to this email to let us know.",
    },
  };
};
...
const forgotPasswordMailgenContent = (
  ...
  return {
    body: {
      ...
      outro:
        "If you did not request to reset your password, please ignore this email or reply to this email to let us know.",
    },
  };
};
