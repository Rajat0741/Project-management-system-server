...
import { TasksStatusEnum } from "../utils/constants.js";
import { uploadAttachment as uploadToImageKit, deleteFile, deleteFiles } from "../utils/imagekit.js";
...
const getTasks = asyncHandler(async (req, res) => {
    ...
    const tasks = await Tasks.find({ project: new mongoose.Types.ObjectId(projectId) }).populate("assignedTo", "avatar username fullName");
...
const deleteSubtask = asyncHandler(async (req, res) => {
    ...
    const deletedSubtask = await Subtask.findByIdAndDelete(new mongoose.Types.ObjectId(subtaskId));
...
const assignAttachment = asyncHandler(async (req, res) => {
    ...
    res.status(200).json(
        new ApiResponse(200, attachmentData, "Attachment uploaded successfully")
    );
});
...
const deleteAttachment = asyncHandler(async (req, res) => {
    ...
    const attachmentIndex = task.attachments.findIndex(att => att.fileId === fileId);
